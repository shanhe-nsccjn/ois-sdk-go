...
import (
	...
	"github.com/shanhe-nsccjn/ois-sdk-go/v4/internal/pkg/logger"
...
// LoadUserConfig loads user configuration in ~/.ois/config.yaml for Config.
...
// FIXME usr.Parse not parse domain without scheme, eg: "ois.com"
