...
func TestRequestSend(t *testing.T) {
	...
	assert.Equal(t, r.HTTPRequest.URL.String(), "https://ois.com:443/aaa/bbb/ccc-ddd?upload_id=0")
	...
	responseString := `{
	  ...
	  "url": "http://docsv3.shanhe.com/object_storage/api/object/get.html"
	}`
