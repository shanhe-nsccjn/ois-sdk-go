...
func TestOISBuilder_BuildHTTPRequest(t *testing.T) {
	...
	assert.Equal(t, "https://beta.ois.dev:443/test/path/to/key.txt", httpRequest.URL.String())
}

func TestOISBuilder_BuildHTTPRequestWithDisableURICleaning(t *testing.T) {
	conf, err := config.NewDefault()
