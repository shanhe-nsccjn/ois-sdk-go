...
```go
// https://docsv3.shanhe.com/ois/api/object/multipart/list_multipart.html
...
ETag header is not required to be set. For details, please refer to [api docs] (https://docsv3.shanhe.com/ois/api/object/multipart/complete_multipart_upload.html).
