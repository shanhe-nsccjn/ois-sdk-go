...
// Package service provides OIS Service API (API Version 2016-01-06)
package service
...
// Service OIS provides low-cost and reliable online storage service with unlimited storage space, high read and write performance, high reliability and data safety, fine-grained access control, and easy to use API.
type Service struct {
...
// Documentation URL: https://docsv3.shanhe.com/ois/api/service/get.html
